...
define('_MI_INFO_CONF1_DESC',
       'YES for Editor selection in the Form, NO for the default Editor');
define('_MI_INFO_CONF2', "Show Link 'Create Page'");
define('_MI_INFO_CONF2_DESC',
       'If you have create permission for hand, a link in the main menu to be displayed.');
...
define('_MI_INFO_CONF5_DESC',
       'Settings of the left and right blocks when calling the submit.php');
...
define('_MI_INFO_LASTD3',
       'medium Date (=> ' . formatTimestamp(time(), 'm') . ')');
...
define('_MI_INFO_CONF8_DESC',
       'Convert URL into SEO-friendly. You need to set mod_rewrite!');
...
define('_MI_INFO_CONF_COLS_DESC',
       'Is the column (height) of the Editor (no HTML editor)');
define('_MI_INFO_CONF_ROWS', 'are the rows of editor of (at least 10)');
define('_MI_INFO_CONF_ROWS_DESC',
       'Returns the rows (width) of the Editor (no HTML editor)');
...
define('_MI_INFO_CONF_HEIGHT_DESC',
       'The height of the input field of the editor in pixels.');
