...
define('_MI_INFO_BLOCK2_DESC',
       'Zeigt einen beliebigen Beitrag in einem Block an');

define('_MI_INFO_CONF1', 'Editorauswahl zulassen');
define('_MI_INFO_CONF1_DESC',
       'Ja für Editorauswahl im Formular / Nein für den Defaulteditor des Systems');
...
define('_MI_INFO_CONF5_DESC',
       'Einstellungen der linken und rechten Blöcke beim Aufruf der submit.php');
define('_MI_INFO_TEMPL1', 'SeitenLayout');
define('_MI_INFO_LASTD1', 'keine Anzeige');
define('_MI_INFO_LASTD2',
       'kurze Anzeige (=> ' . formatTimestamp(time(), 's') . ')');
define('_MI_INFO_LASTD3',
       'normale Anzeige (=> ' . formatTimestamp(time(), 'm') . ')');
define('_MI_INFO_LASTD4',
       'lange Anzeige (=> ' . formatTimestamp(time(), 'l') . ')');
...
define('_MI_INNFO_ARTFOUND',
       'Hier ist ein interessanter Artikel den ich auf %s gefunden habe');
...
define('_MI_INFO_CONF9_DESC',
       'gibt das führende Trennzeichen für Untermenüs am Anfang an.');
...
define('_MI_INFO_CONF_COLS_DESC',
       'Gibt die Spalten (Höhe) des Editors an (kein HTML-Editor)');
define('_MI_INFO_CONF_ROWS', 'gibt die Reihen des Editors an (mind.10)');
define('_MI_INFO_CONF_ROWS_DESC',
       'Gibt die Reihen (Breite) des Editors an (kein HTML-Editor)');
define('_MI_INFO_CONF_WIDTH', 'Breite HTML-Editor in Prozent (10-100)');
define('_MI_INFO_CONF_WIDTH_DESC',
       'legt die prozentuale Breite des Editors fest (nur für HTML-Editoren)');
define('_MI_INFO_CONF_HEIGHT', 'Höhe HTML-Editor in Pixel (mind. 100)');
define('_MI_INFO_CONF_HEIGHT_DESC',
       'Die Höhe des Eingabefeldes des Editors in Pixeln.');
